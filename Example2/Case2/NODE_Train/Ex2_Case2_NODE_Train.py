...
filename = f"Ex2_Case2_NODE_Weight_{date_str}.mat"
sio.savemat(filename, data_dict)

sio.savemat('Ex2_Case2_NODE_Loss.mat', {"Loss": Loss_NODE_out })
...
sio.savemat('Ex2_Case2_NODE_trajectory.mat', {"data": z_node_array })
sio.savemat('Ex2_Case2_True_trajectory.mat', {"data": z_true_array })
