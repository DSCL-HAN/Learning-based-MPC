%% Example 2 - Case 2 - Neural ODE based LMPC
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Copyright (C)
...
global a b c W1 W2 W3 B1 B2 B3
load('Ex2_Case2_NODE_Weight_250211.mat')
...
for i = 1:sample_size
    ...
    z(:,i+1) = rk5(z(:,i),(i-1)*ti,ti);
    z_real(:,i+1) = rk7(z_real(:,i),(i-1)*ti,ti);
...
% save(['w=00350_NODE_MPC_Date_',num2str(time)])
