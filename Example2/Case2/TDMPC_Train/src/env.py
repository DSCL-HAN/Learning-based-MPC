...
class TimeStepToGymWrapper(object):
	...
	def __init__(self, env, domain, task, action_repeat, modality,cfg):
...
def make_env(cfg):
	...
	Adapted from https://github.com/facebookresearch/drqv2 # model free off policy algorithm
	"""
	if cfg.task == 'mp-custom': 
		...
		env = TimeStepToGymWrapper(env, domain, task, cfg.action_repeat, cfg.modality,cfg)
